...
* [How can you avoid callback hells?](#how-can-you-avoid-callback-hells-js-getdata-function-a-getmoredata-a-function-b-getmoredata-b-function-c-getmoredata-c-function-d-getmoredata-d-function-e)
...
* [NodeJS uses a callback pattern in many instances where if an error were returned it will pass it as the first argument to the callback. What are the advantages of this pattern?](#nodejs-uses-a-callback-pattern-in-many-instances-where-if-an-error-were-returned-it-will-pass-it-as-the-first-argument-to-the-callback-what-are-the-advantages-of-this-pattern-js-fs-readfile-filepath-function-err-data-if-err-handle-the-error-the-return-is-important-here-so-execution-stops-here-return-console-log-err-use-the-data-object-console-log-data)
